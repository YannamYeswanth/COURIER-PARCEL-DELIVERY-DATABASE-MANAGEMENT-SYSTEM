...
class Orders(models.Model):
    ...
    Sender_Employee_Id=models.ForeignKey(Employees,related_name='employee1',on_delete=models.CASCADE)
    Receiver_Name_Employee_Id=models.ForeignKey(Employees,related_name='employee2',on_delete=models.CASCADE)
